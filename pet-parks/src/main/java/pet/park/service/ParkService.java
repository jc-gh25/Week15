...
public class ParkService {
	...
	public List<ContributorData> retrieveAllContributors() {
		...
		// One way to get the contributors with enhanced for loop
		/*
		 ...
		 * ContributorData(contributor)); } return response;
		 */

		// Another way to get the contributors with stream map
		// @formatter:off
		return contributorDao.findAll()
				.stream()
				.map(cont -> new ContributorData(cont))
				// or .map(ContributorData::new)
				.toList();
		// @formatter:on
	}
